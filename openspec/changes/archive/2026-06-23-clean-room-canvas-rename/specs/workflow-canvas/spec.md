...
- FROM: `### Requirement: Idempotent Continuation (Chain)`
  TO: `### Requirement: Idempotent Continuation (Sequence)`
- FROM: `### Requirement: Chord Watcher Self-Rescheduling`
  TO: `### Requirement: Fan-In Watcher Self-Rescheduling`
- FROM: `### Requirement: Chord dependency identity is causally guaranteed`
  TO: `### Requirement: Fan-in dependency identity is causally guaranteed`
- FROM: `### Requirement: Chord Watcher Payload Validation`
  TO: `### Requirement: Fan-In Watcher Payload Validation`
