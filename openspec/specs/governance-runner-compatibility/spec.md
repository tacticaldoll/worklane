# Governance Runner Compatibility Specification

## Purpose

Defines the observable projection, reaction, and compatibility contract the
workspace governance runner preserves when its Tianheng dependency evolves.
