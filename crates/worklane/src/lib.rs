...
pub use canvas::{Canvas, ChordPolicy, ChordResults};
/// The chord watcher job/payload are an implementation detail of [`Client::chord`]
...
#[doc(hidden)]
pub use canvas::{ChordWatcherJob, ChordWatcherPayload};
